...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(KILLSWITCH_Pin);
  HAL_GPIO_EXTI_IRQHandler(PROF_1_BTN_Pin);
  HAL_GPIO_EXTI_IRQHandler(PROF_2_BTN_Pin);
  HAL_GPIO_EXTI_IRQHandler(PROF_3_BTN_Pin);
